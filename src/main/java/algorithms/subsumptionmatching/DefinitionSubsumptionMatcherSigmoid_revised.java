...
import algorithms.utilities.WNDomain;
...
public class DefinitionSubsumptionMatcherSigmoid_revised extends ObjectAlignment implements AlignmentProcess, Algorithm {
	...
	public DefinitionSubsumptionMatcherSigmoid_revised(){}
	
	public DefinitionSubsumptionMatcherSigmoid_revised(OWLOntology onto1, OWLOntology onto2, double profileScore, int slope, double rangeMin, double rangeMax) {
	...
	public static void main(String[] args) throws AlignmentException, IOException, URISyntaxException, OWLOntologyCreationException {
		...
		AlignmentProcess a = new DefinitionSubsumptionMatcherSigmoid_revised(sourceOntology, targetOntology, profileScore, slope, rangeMin, rangeMax);
	...
	public static URIAlignment returnDSMAlignment (File ontoFile1, File ontoFile2, double profileScore, int slope, double rangeMin, double rangeMax) throws OWLOntologyCreationException, AlignmentException {
		...
		AlignmentProcess a = new DefinitionSubsumptionMatcherSigmoid_revised(onto1, onto2, profileScore, slope, rangeMin, rangeMax);
		a.init(ontoFile1.toURI(), ontoFile2.toURI());
		Properties params = new Properties();
		params.setProperty("", "");
		a.align((Alignment)null, params);	
