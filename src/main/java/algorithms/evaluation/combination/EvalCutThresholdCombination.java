...
public class EvalCutThresholdCombination {
	...
	public static void main(String[] args) throws AlignmentException, URISyntaxException, OWLOntologyCreationException, JWNLException, IOException {
		...
		eq_folder = "./files/_PHD_EVALUATION/_EVALUATION_SYNPRECREC/"+DATASET+"/ALIGNMENTS/CUT_THRESHOLD/MERGED_NOWEIGHT/EQ";
		sub_folder = "./files/_PHD_EVALUATION/_EVALUATION_SYNPRECREC/"+DATASET+"/ALIGNMENTS/CUT_THRESHOLD/MERGED_NOWEIGHT/SUB";
...
//			evalScore.setfMeasure(fMeasure);
		...
		Evaluator.evaluateSingleMatcherThresholds(eqEvaluationMap, "./files/_PHD_EVALUATION/_EVALUATION_SYNPRECREC/"+DATASET+"/ALIGNMENTS/CUT_THRESHOLD/CUT_THRESHOLD_EQ_ONLY_"+date);
...
//			evalScore.setfMeasure(fMeasure);
		...
		Evaluator.evaluateSingleMatcherThresholds(subEvaluationMap, "./files/_PHD_EVALUATION/_EVALUATION_SYNPRECREC/"+DATASET+"/ALIGNMENTS/CUT_THRESHOLD/CUT_THRESHOLD_SUB_ONLY_"+date);
...
//			evalScore.setfMeasure(fMeasure);
			...
			outputAlignment = new File("./files/_PHD_EVALUATION/_EVALUATION_SYNPRECREC/"+DATASET+"/ALIGNMENTS/CUT_THRESHOLD/MERGED_NOWEIGHT/CutThreshold"+DATASET+"_"+conf+".rdf");
		...
		Evaluator.evaluateSingleMatcherThresholds(evaluationMap, "./files/_PHD_EVALUATION/_EVALUATION_SYNPRECREC/"+DATASET+"/ALIGNMENTS/CUT_THRESHOLD/CUT_THRESHOLD_"+date);
